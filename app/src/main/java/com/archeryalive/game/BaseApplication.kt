...
private const val LOG_TAG = "openAd"
...
class BaseApplication : Application(), Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    companion object {
        ...
        private val TAG = BaseApplication::class.java.canonicalName
    }
    ...
    private fun initAf() {
        AppsFlyerLib.getInstance()
            .init("KHgmxcndMCFUbJDKZq6Qjh", object : AppsFlyerConversionListener {
