...
public class ServerManager extends BroadcastReceiver {
    ...
    public void register() {
        ...
        mActivity.getApplicationContext().registerReceiver(this, filter);
    }
    ...
    public void startServer() {
        mActivity.getApplicationContext().startService(mService);
    }

    public void stopServer() {
        mActivity.getApplicationContext().stopService(mService);
    }
